...
public class MultiplayerTileMovement : MonoBehaviour
{
    ...
    void OnEnable() {
        // INPUT
        if (firstPlayer) {
            TwoPlayerInputMap.OnShiftBlock1P += shiftBlock;
            TwoPlayerInputMap.OnDropBlock1P += dropBlock;
            TwoPlayerInputMap.OnHeldMod1P += heldModify;
            TwoPlayerInputMap.OnPressedMod1P += pressedModify;
        }
        else {
            TwoPlayerInputMap.OnShiftBlock2P += shiftBlock;
            TwoPlayerInputMap.OnDropBlock2P += dropBlock;
            TwoPlayerInputMap.OnHeldMod2P += heldModify;
            TwoPlayerInputMap.OnPressedMod2P += pressedModify;
        }
    ...
    if (_currentTile is not null) {
        ...
        if (firstPlayer) OnScoreChange?.Invoke((rowsCleared * 400) + 50);
        else OnScoreChange?.Invoke(-((rowsCleared * 400) + 50));
    }
}
